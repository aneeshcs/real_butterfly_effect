"""Train the NS2D CNN surrogate with Generalized Teacher Forcing (GTF)."""
...
class NS2DDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        x_target = self.data[i, t + 1 : t + 1 + self.K_steps]
        return x_start, x_target


def main():
    parser = argparse.ArgumentParser(description="Train NS2D CNN surrogate")
    ...
    train_ds = NS2DDataset(train_data, K_steps=1, seed=args.seed)
